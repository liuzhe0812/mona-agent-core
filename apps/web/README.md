...
无需 `.env` 或 `npm install`。首次在模型设置页添加供应商；未配置模型时不会退回假模型。完整说明见 [本地开发文档](../../docs/DEVELOPMENT.zh-CN.md)。
...
- `index.html`、`app.mjs`、`styles.css` 是正式通用界面，但不包含产品账号、Session 数据库或工作区权限系统。
