...
#[tauri::command]
async fn get_snapshot<R: Runtime>(webview: Webview<R>, state: State<'_, NativeState>, run_id: String) -> ApplicationResult<agent_api::RunSnapshot> {
