...
pub trait SettingsStore: Send + Sync {
    fn load(&self) -> api::Result<Option<Vec<u8>>>;
    fn save(&self, bytes: &[u8]) -> api::Result<()>;
}
...
impl EncryptedFileStore {
    ...
    pub fn new(path: PathBuf, key_material: &str) -> api::Result<Self> {
    ...
    fn cipher(&self) -> api::Result<Aes256Gcm> {
